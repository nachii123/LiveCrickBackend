package com.cricket_Api.cricketScore.Entity;
...
public class Matches {
    ...
    public Matches(int matchId, String teamHeading, String matchNumberVenue, String battingTeam, String battingTeamScore, String bowlTeam, String bowlTeamScore, String liveText, String matchLink, String textComplete, MatchStatus status, Date date) {
    ...
    // set the match Status according to textComplted
